...
add-creds:
	...
	secrets/local-ssm-add.sh /concourse/pay-deploy/docker-username docker/readonly-user/username
	secrets/local-ssm-add.sh /concourse/pay-deploy/docker-password docker/readonly-user/password
